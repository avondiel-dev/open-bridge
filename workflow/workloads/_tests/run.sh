...
declare -a NEEDLES=(
  ...
  "environment-may-carry-a-value@@pattern: '^(azure-keyvault|keychain|1password|keepass|op|vault|file)://\\S+$'   # a locator, never a value@@pattern: '^.*$'   # a locator, never a value@@negative-secret-in-environment.yaml"
